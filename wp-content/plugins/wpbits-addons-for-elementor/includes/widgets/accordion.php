...
class Widget_WPBITS_AFE_Accordion extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Background', 'wpbits-addons-for-elementor' ),
				'types' => [ 'classic', 'gradient' ],
				'selector' => '{{WRAPPER}} .wpb-accordions .wpbaccordion__head i,{{WRAPPER}} .wpb-accordions .wpbaccordion__head button i,{{WRAPPER}} .wpb-accordions .wpbaccordion__head .wpbaccordion-prefix,{{WRAPPER}} .wpb-accordions .wpbaccordion__head button .wpbaccordion-prefix'
			]
		);  
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Background', 'wpbits-addons-for-elementor' ),
				'types' => [ 'classic', 'gradient' ],
				'selector' => '{{WRAPPER}} .wpb-accordions .wpbaccordion__head:hover i,{{WRAPPER}} .wpb-accordions .wpbaccordion__head button:hover i,{{WRAPPER}} .wpb-accordions .wpbaccordion.is-open .wpbaccordion__head i,{{WRAPPER}} .wpb-accordions .wpbaccordion.is-open .wpbaccordion__head button i',
				'{{WRAPPER}} .wpb-accordions .wpbaccordion__head:hover .wpbaccordion-prefix,{{WRAPPER}} .wpb-accordions .wpbaccordion__head button:hover .wpbaccordion-prefix,{{WRAPPER}} .wpb-accordions .wpbaccordion.is-open .wpbaccordion__head .wpbaccordion-prefix,{{WRAPPER}} .wpb-accordions .wpbaccordion.is-open .wpbaccordion__head button .wpbaccordion-prefix' => 'color: {{VALUE}};'
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'rem' ],
				'selectors' => [
                    '{{WRAPPER}} .wpb-accordions .wpbaccordion__head i,{{WRAPPER}} .wpb-accordions .wpbaccordion__head .wpbaccordion-prefix' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				],
			]
		);
    ...
    protected function render() {
		...
		$rand = '-' . rand();
        if ( $settings['list'] ) { ?>
            <div class="wpb-accordions" data-selfclose="<?php echo $settings['self_close']; ?>" data-opensingle="<?php echo $settings['open_single']; ?>" data-openspeed="<?php echo $settings['open_speed']; ?>" data-closespeed="<?php echo $settings['close_speed']; ?>" data-autoscroll="<?php echo $settings['scroll']; ?>" data-scrollspeed="<?php echo $settings['scroll_speed']; ?>" data-scrolloffset="<?php echo $settings['scroll_offset']; ?>">
            <?php foreach ( $settings['list'] as $item ) { ?>   
                <div id="wpb-<?php echo $item['_id'] . $rand; ?>" <?php if ($settings['hash']) { ?>data-hash="#wpb-<?php echo $item['_id'] . $rand; ?>"<?php } ?> class="wpbaccordion <?php echo $item['status']; ?>" data-wpbaccordion-options='{"selfBlock": <?php echo $item['self_block']; ?>}'>
                    <?php echo '<' . $settings['html_tag'] . ' class="wpbaccordion__head">'; ?>
						<?php \Elementor\Icons_Manager::render_icon( $item['title_icon'], [ 'aria-hidden' => 'true' ] ); ?>
						<?php if ($item['title_icon_txt']) { echo '<span class="wpbaccordion-prefix">' . $item['title_icon_txt'] . '</span>'; } ?>
						<?php echo $item['title']; ?>
