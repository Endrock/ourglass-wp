!(function ($) {
  ...
  function switchWord($oldWord, $newWord) {
    ...
    jQuery(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction( 'frontend/element_ready/wixi-animated-headline.default', ntrAnimatedHeadline );
        elementorFrontend.hooks.addAction('frontend/element_ready/wixi-onepage.default', ntrAnimatedHeadline);
    });
