...
class Wixi_Mega_Menu extends Widget_Base {
    use Wixi_Helper;

    public function get_name() {
        return 'Wixi-mega-menu';
    }
    ...
    public function __construct($data = [], $args = null) {
        ...
        //wp_register_style( 'wixi-hamburgers', WIXI_PLUGIN_URL. 'widgets/mega-menu/hamburgers.css');
        wp_register_style( 'wixi-mega-menu', WIXI_PLUGIN_URL. 'widgets/mega-menu/style.css');
        wp_register_script( 'wixi-mega-menu', WIXI_PLUGIN_URL. 'widgets/mega-menu/script.js', [ 'elementor-frontend' ], '1.0.0', true);
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section('megamenu_general_settings',
            [
                'label' => esc_html__( 'Mega Menu', 'wixi' ),
        ...
        $repeater->add_control( 'mega_content_type',
            [
                ...
                'default' => 'custom',
                'options' => [
                    'wp-menu' => esc_html__( 'Use Wp Menu', 'wixi' ),
                    'custom' => esc_html__( 'Custom Content', 'wixi' )
                ]
            ]
        );
        // Exclude Category
        ...
        $repeater->add_control( 'menu_layout_type',
            [
                'label' => esc_html__( 'Menu Type', 'wixi' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'vertical-menu',
                'options' => [
                    'vertical-menu' => esc_html__( 'Vertical', 'wixi' ),
                    'horizontal-menu' => esc_html__( 'Horizontal', 'wixi' )
                ],
                'condition' => [ 'mega_content_type' => 'wp-menu' ],
                'separator' => 'before'
            ]
        ...
        $repeater->add_control( 'mega_menu_column',
            [
                ...
                'default' => 'column-4',
                'options' => [
                    'column-2' => esc_html__( '2 Column', 'wixi' ),
                    'column-3' => esc_html__( '3 Column', 'wixi' ),
                    'column-4' => esc_html__( '4 Column', 'wixi' ),
                    'column-5' => esc_html__( '5 Column', 'wixi' ),
                    'column-6' => esc_html__( '6 Column', 'wixi' ),
                ],
        ...
        $repeater->add_control( 'mega_menu_column_height',
            [
                'label' => esc_html__( 'Column Height', 'wixi' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'column-auto',
                'options' => [
                    'column-auto' => esc_html__( 'Auto', 'wixi' ),
                    'column-h-full' => esc_html__( '100%', 'wixi' ),
                ],
                'condition' => [ 'menu_layout_type' => 'horizontal-menu' ]
            ]
        );
        $repeater->add_control( 'mega_menu_column_gap',
            [
                'label' => esc_html__( 'Gap Between Column', 'wixi' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'column-gap-5',
                'options' => [
                    'column-gap-1' => esc_html__( '1px', 'wixi' ),
                    'column-gap-2' => esc_html__( '2px', 'wixi' ),
                    'column-gap-3' => esc_html__( '3px', 'wixi' ),
                    'column-gap-4' => esc_html__( '4px', 'wixi' ),
                    'column-gap-5' => esc_html__( '5px', 'wixi' ),
                    'column-gap-6' => esc_html__( '6px', 'wixi' ),
                    'column-gap-7' => esc_html__( '7px', 'wixi' ),
                    'column-gap-8' => esc_html__( '8px', 'wixi' ),
                    'column-gap-9' => esc_html__( '9px', 'wixi' ),
                    'column-gap-10' => esc_html__( '10px', 'wixi' ),
                    'column-gap-15' => esc_html__( '15px', 'wixi' ),
                    'column-gap-20' => esc_html__( '20px', 'wixi' ),
                    'column-gap-25' => esc_html__( '25px', 'wixi' ),
                    'column-gap-30' => esc_html__( '30px', 'wixi' ),
                ],
                'condition' => [ 'menu_layout_type' => 'horizontal-menu' ]
            ]
        );
        $repeater->add_control( 'container_max_width',
            [
                'label' => esc_html__( 'Container Max Width ( % )', 'wixi' ),
        ...
        $repeater->add_control( 'opac_effect',
            [
                'label' => esc_html__( 'Opacity on Hover Column?', 'wixi' ),
        ...
        $repeater->add_control( 'mega_menu_column_action',
            [
                'label' => esc_html__( 'Column Open Action', 'wixi' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'column-auto',
                'options' => [
                    'column-action-hover' => esc_html__( 'On Hover', 'wixi' ),
                    'column-action-click' => esc_html__( 'On Click', 'wixi' ),
                ],
                'condition' => [ 'menu_layout_type' => 'horizontal-menu' ]
            ]
        );
        $repeater->add_control( 'header_horizontal_menu_alignment',
            [
                'label' => esc_html__( 'Menu Item Alignment', 'wixi' ),
        ...
        $repeater->add_responsive_control( 'flyout',
            [
                'label' => esc_html__( 'Flyout Submenu', 'wixi' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'flyout-left' => [
                        'title' => esc_html__( 'Left', 'wixi' ),
        ...
        $repeater->add_control( 'megamenu_content',
            [
                'label' => esc_html__( 'Mega Menu Content', 'wixi' ),
                'type' => Controls_Manager::SELECT2,
                'default' => '',
                'multiple' => false,
        ...
        $this->add_control( 'sticky',
            [
                'label' => esc_html__( 'Sticky Header?', 'wixi' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'no',
            ]
        );
        ...
        $this->start_controls_section( 'header_style_controls_section',
            [
                'label' => esc_html__( 'Desktop Header Container', 'wixi' ),
                'tab' => Controls_Manager::TAB_CONTENT
            ]
        );
        $this->add_control( 'header_desktop_heading',
            [
                'label' => esc_html__( 'HEADER CONTAINER', 'wixi' ),
        ...
        $this->start_controls_section( 'header_desktop_primary_a_controls',
            [
                'label' => esc_html__( 'Desktop Menu Primary Items', 'wixi' ),
                'tab' => Controls_Manager::TAB_CONTENT
            ]
        );
        ...
        $this->add_control( 'menu_heading',
            [
                'label' => esc_html__( 'MENU ITEMS', 'wixi' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before'
            ]
        );
        ...
        $this->add_control( 'menu_item_padding',
            [
                'label' => esc_html__( 'Width ( Inner Spacing )', 'wixi' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 0,
                'max' => 100,
                'step' => 1,
        ...
        $this->add_control( 'menu_item_gap',
            [
                'label' => esc_html__( 'Gap between Items', 'wixi' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 0,
                'max' => 100,
                'step' => 1,
        ...
        $this->start_controls_section( 'header_desktop_vertical_submenu_controls',
            [
                'label' => esc_html__( 'Desktop Vertical Submenu', 'wixi' ),
                'tab' => Controls_Manager::TAB_CONTENT
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control( 'v_submenu_top_offset',
            [
                'label' => esc_html__( 'Submenu > Submenu Top Offset ( Negatif )', 'wixi' ),
                'description' => esc_html__( 'You can use this option for Submenu vertical position', 'wixi' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 0,
                'max' => 100,
                'step' => 1,
        ...
        $this->start_controls_section( 'header_desktop_horizontal_submenu_controls',
            [
                'label' => esc_html__( 'Desktop Horizontal Submenu', 'wixi' ),
                'tab' => Controls_Manager::TAB_CONTENT
            ]
        );
        $this->add_control( 'horizontal_submenu_container_heading',
            [
                'label' => esc_html__( 'CONTAINER', 'wixi' ),
                'type' => Controls_Manager::HEADING,
                'separator'=> 'before'
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Container Background', 'wixi' ),
                'types' => [ 'classic','gradient' ],
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Hover Column Box Shadow', 'wixi' ),
        ...
        $this->add_control( 'horizontal_submenu_column_padding',
            [
                'label' => esc_html__( 'Column Padding', 'wixi' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', 'em', '%' ],
        ...
        $this->add_control( 'horizontal_submenu_column_label_heading',
            [
                'label' => esc_html__( 'COLUMN LABEL ( First Item )', 'wixi' ),
                'type' => Controls_Manager::HEADING,
                'separator'=> 'before'
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Column Label Typography', 'wixi' ),
                'scheme' => \Elementor\Core\Schemes\Typography::TYPOGRAPHY_1,
        ...
        $this->add_control( 'horizontal_submenu_column_label_color',
            [
                'label' => esc_html__( 'Column Label Color', 'wixi' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control( 'mobile_breakpoint',
            [
                'label' => esc_html__( 'Mobile Menu Breakpoint', 'wixi' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 480,
                'max' => 1400,
                'step' => 50,
        ...
        $this->add_control( 'header_mobile_height',
            [
                'label' => esc_html__( 'Mobile Header Height', 'wixi' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 50,
                'max' => 300,
                'step' => 1,
        ...
        $this->add_control( 'header_mobile_toggle_btn_heading',
            [
                'label' => esc_html__( 'TOGGLE BUTTON', 'wixi' ),
                'type' => Controls_Manager::HEADING,
                'separator'=> 'before'
            ]
        );
        ...
        $this->add_control( 'mobile_menu_toggle',
            [
                'label' => esc_html__( 'Toggle Button Color', 'wixi' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control( 'mobile_menu_toggle_close',
            [
                'label' => esc_html__( 'Toggle Button Close Color', 'wixi' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->start_controls_section( 'header_template_content_controls',
            [
                'label' => esc_html__( 'Template Container', 'wixi' ),
                'tab' => Controls_Manager::TAB_CONTENT
            ]
        );
    ...
    public function wixi_megamenu_prefix_nav_description( $item_output, $item, $depth, $args ) {
    ...
    protected function render()
    {
        ...
        add_filter( 'walker_nav_menu_start_el', [$this, 'wixi_megamenu_prefix_nav_description'], 10, 4 );

        echo '<header class="nt-header nt-desktop'.$sticky.'" data-breakpoint="'.$settings['mobile_breakpoint'].'">';

            echo '<div class="hamburger-wrapper"><button class="hamburger hamburger--elastic" type="button" aria-label="'.esc_html__('Menu','wixi').'" aria-controls="navigation">
            ...
            echo '</nav>';
        echo '</header>';
        remove_filter( 'walker_nav_menu_start_el', [$this, 'wixi_megamenu_prefix_nav_description'], 10, 4 );
    }
}
