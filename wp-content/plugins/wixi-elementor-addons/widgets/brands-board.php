...
class Wixi_Brands_Board extends Widget_Base {
    use Wixi_Helper;
    public function get_name() {
        return 'wixi-brands-board';
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section( 'wixi_brands_board_settings',
            [
                'label' => esc_html__( 'Brands Board', 'wixi'),
        ...
        $this->add_control( 'add_line',
            [
                'label' => esc_html__( 'Add Line', 'wixi' ),
        ...
        $this->add_control( 'hide_split',
            [
                'label' => esc_html__( 'Hide Splitting', 'wixi' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'no',
                'separator' => 'before',
            ]
        ...
        $repeater->add_control( 'title',
            [
                'label' => esc_html__('Brand Title', 'wixi'),
                'type' => Controls_Manager::TEXT,
                'default' => 'www.wixi.com',
                'label_block' => true
            ]
        );
