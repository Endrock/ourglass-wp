...
class Wixi_Justified_Gallery extends Widget_Base {
    use Wixi_Helper;
    public function get_name() {
        return 'wixi-justified-gallery';
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section( 'wixi_justified_gallery_images_settings',
            [
        ...
        /*****   START CONTROLS SECTION   ******/
        $this->start_controls_section( 'wixi_justified_gallery_settings',
            [
        ...
        $this->add_control( 'rows',
            [
                'label' => esc_html__( 'Rows Height', 'wixi' ),
        ...
        $this->add_control( 'margins',
            [
                'label' => esc_html__( 'Space Between Images', 'wixi' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 0,
                'max' => 200,
                'step' => 5,
        ...
        $this->add_control( 'lastrow',
            [
                'label' => esc_html__( 'Last Row Justify', 'wixi' ),
    ...
    protected function render() {
        ...
        echo '<div class="projdtal">';
            echo '<div class="justified-gallery" id="justified-'.$elementid.'" data-wixi-justified=\'{"rows":'.$rows.',"margins":'.$margins.',"lastrow":"'.$lastrow.'"}\' data-wixi-lightbox=\'{"type":"gallery","selector":".gallery-photo"}\'>';
        ...
        if ( \Elementor\Plugin::$instance->editor->is_edit_mode() ) { ?>
            ...
            jQuery(document).ready(function ($) {
                function wixiJustifiedGallery() {
                    var myJustified = $('#justified-<?php echo esc_attr($elementid);?>');
                    var myData= myJustified.data('wixi-justified');
