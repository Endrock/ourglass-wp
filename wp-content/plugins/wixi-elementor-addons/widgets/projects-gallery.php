...
class Wixi_Projects_Gallery extends Widget_Base {
    use Wixi_Helper;
    public function get_name() {
        return 'wixi-projects-gallery';
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section( 'post_query_section',
            [
                'label' => esc_html__( 'Projects Query', 'wixi' ),
                'tab' => Controls_Manager::TAB_CONTENT
            ]
        );
        $this->add_control( 'query_type',
            [
                'label' => esc_html__( 'Query Type', 'wixi' ),
                'type' => Controls_Manager::SELECT,
                'label_block' => 'true',
                'default' => 'thm',
                'options' => [
                    'thm' => esc_html__( 'Theme Project', 'wixi' ),
                    'custom' => esc_html__( 'Custom Post Type', 'wixi' ),
                ]
            ]
        );
        ...
        $this->add_control( 'tags_exclude',
            [
                'label' => esc_html__( 'Exclude Tags', 'wixi' ),
                'type' => Controls_Manager::SELECT2,
                'multiple' => true,
        ...
        $this->add_control( 'orderby',
            [
                ...
                'options' => [
                    ...
                    'menu_order' => esc_html__( 'Menu Order', 'wixi' ),
        ...
        $this->add_control( 'layoutmode',
            [
                'label' => esc_html__( 'Layout Mode', 'wixi' ),
                'type' => Controls_Manager::SELECT,
                'label_block' => 'true',
                'default' => 'fitRows',
                'options' => [
                    'fitRows' => esc_html__( 'Fit Rows', 'wixi' ),
                    'masonry' => esc_html__( 'masonry', 'wixi' ),
                ]
            ]
        );
        ...
        $this->add_control( 'hidetitle',
            [
                'label' => esc_html__( 'Hide Post Title', 'wixi' ),
        ...
        $this->start_controls_section( 'custom_query_section',
            [
                'label' => esc_html__( 'Custom Query', 'wixi' ),
                'tab' => Controls_Manager::TAB_CONTENT,
                'condition' => ['query_type' => 'custom']
            ]
        );
        $this->wixi_query_controls( 'projects', $pag=false, $filter=true );
        ...
        $this->start_controls_section( 'post_filter_section',
            [
                'label' => esc_html__( 'Filters', 'wixi' ),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        $this->add_control( 'hide_filters',
            [
                'label' => esc_html__( 'Hide Filters', 'wixi' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'no',
                'return_value' => 'yes'
            ]
        ...
        $this->add_control( 'all_text',
            [
                'label' => esc_html__( 'All Text', 'wixi' ),
        ...
        $this->start_controls_section( 'projects_gallery_style_section',
            [
                'label' => esc_html__( 'Item Style', 'wixi' ),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->wixi_style_border( 'projects_gallery_image_border', '{{WRAPPER}} .portfolio .gallery .items .item-img' );
        $this->wixi_style_padding( 'projects_gallery_image_padding', '{{WRAPPER}} .portfolio .gallery .items .item-img' );
        ...
        $this->wixi_style_color( 'projects_gallery_title_color', '{{WRAPPER}} .portfolio .gallery .items .overlay-info h5' );
        $this->wixi_style_typo( 'projects_gallery_title_typo', '{{WRAPPER}} .portfolio .gallery .items .overlay-info h5' );
        ...
        $this->wixi_style_color( 'projects_gallery_excerpt_color', '{{WRAPPER}} .portfolio .gallery .items .overlay-info P' );
        $this->wixi_style_typo( 'projects_gallery_excerpt_typo', '{{WRAPPER}} .portfolio .gallery .items .overlay-info P' );
        $this->wixi_style_padding( 'projects_gallery_excerpt_padding', '{{WRAPPER}} .portfolio .gallery .items .overlay-info P' );
        $this->wixi_style_margin( 'projects_gallery_excerpt_margin', '{{WRAPPER}} .portfolio .gallery .items .overlay-info P' );
        ...
        $this->start_controls_section( 'projects_gallery_filter_style_section',
            [
                'label' => esc_html__( 'Fılter Style', 'wixi' ),
                'tab' => Controls_Manager::TAB_CONTENT,
                'condition' => [ 'hide_filters!' => 'yes' ]
            ]
        );
        ...
        $this->add_responsive_control( 'projects_gallery_filter_space',
            [
                'label' => esc_html__( 'Space Between Item', 'wixi' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 0,
                'max' => 100,
                'step' => 1,
        ...
        $this->wixi_style_color( 'projects_slider_color','{{WRAPPER}} .portfolio .filtering span' );
        $this->wixi_style_bgcolor( 'projects_gallery_filter_background','{{WRAPPER}} .portfolio .filtering span' );
        $this->end_controls_tab();

        $this->start_controls_tab( 'projects_gallery_filter_hover_tab',
            [ 'label' => esc_html__( 'Hover', 'wixi' ) ]
        );
        $this->wixi_style_color( 'projects_gallery_filter_hvr_color','{{WRAPPER}} .portfolio .filtering span:hover, {{WRAPPER}} .portfolio .filtering span.active' );
        $this->wixi_style_bgcolor( 'projects_gallery_filter_hvr_background','{{WRAPPER}} .portfolio .filtering span:hover, {{WRAPPER}} .portfolio .filtering span.active' );
        $this->end_controls_tab();
        $this->end_controls_tabs();
        $this->add_control( 'projects_gallery_filter_point_heading',
            [
                'label' => esc_html__( 'FILTER POINT', 'wixi' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->add_control( 'projects_gallery_filter_point_color',
            [
                'label' => esc_html__( 'Filter Point Color', 'wixi' ),
        ...
        $this->add_responsive_control( 'projects_gallery_filter_point_position',
            [
                'label' => esc_html__( 'Filter Point Position', 'wixi' ),
                'type' => Controls_Manager::NUMBER,
                'min' => -100,
                'max' => 100,
                'step' => 1,
                ...
                echo '<div class="container-off">';
                    echo '<div class="row">';
                        ...
                        if ( 'custom' == $settings['query_type'] ) {
                            $exclude = array();
                            $taxonomy = '';
                            $post_type = $this->wixi_get_post_types();
                        ...
                        echo '<div class="grid-sizer col-md-'.$settings['column'].'"></div>';
                            ...
                            while ( $the_query->have_posts() ) {
                                ...
                                if ( has_post_thumbnail() ) {
                                    ...
                                    echo '<div class="col-md-'.$settings['column'].' '.$tax.' items wixi-project-id-'.get_the_ID().'" data-project-id="'.get_the_ID().'">';
                                        ...
                                        if ( !( \Elementor\Plugin::$instance->editor->is_edit_mode() ) ) {
                                            ...
                                            echo '<a href="' . get_permalink() . '">';
                                                ...
                                                echo '<div class="item-img-overlay vert-align">';
