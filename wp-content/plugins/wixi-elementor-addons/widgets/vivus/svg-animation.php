...
class Wixi_Svg_Animation extends Widget_Base {
    use Wixi_Helper;
    public function get_name() {
        return 'wixi-svg-animation';
    }
    ...
    public function __construct($data = [], $args = null) {
        ...
        wp_register_style( 'wixi-vivus', WIXI_PLUGIN_URL. 'widgets/vivus/style.css');
        wp_register_script( 'wixi-vivus', WIXI_PLUGIN_URL. 'widgets/vivus/script.js', [ 'elementor-frontend' ], '1.0.0', true);
    }
    public function get_style_depends() {
        return [ 'wixi-vivus' ];
    }
    public function get_script_depends() {
        return [ 'vivus','scrollmagic','wixi-vivus' ];
    }
    // Registering Controls
    protected function register_controls() {
        $this->start_controls_section('wixi_flip_card_general_settings',
            [
                'label' => esc_html__( 'SVG Settings', 'wixi' ),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        $this->add_responsive_control( 'container_w',
            [
                'label' => esc_html__( 'SVG Width', 'wixi' ),
        ...
        $this->add_control( 'svgimage',
            [
                'label' => esc_html__( 'Svg Icon URL', 'wixi' ),
        ...
        $this->add_control( 'reverse',
            [
                'label' => esc_html__( 'Replay on Scroll?', 'wixi' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes',
        ...
        $this->add_control( 'use_grad',
            [
                'label' => esc_html__( 'Use Gradient Color?', 'wixi' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'no',
                'separator' => 'before',
            ]
        ...
        $this->add_control( 'grad_offset',
            [
                'label' => esc_html__( 'Gradient Offset', 'wixi' ),
        ...
        $this->add_control( 'use_fill',
            [
                'label' => esc_html__( 'Fill Color ( after animation finish )', 'wixi' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'no',
                'separator' => 'before',
            ]
        ...
        $this->add_control( 'use_fill_grad',
            [
                'label' => esc_html__( 'Use Gradient?', 'wixi' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'no',
