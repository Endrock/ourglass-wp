!(function () {
    ...
    function elemReveals($scope, $) {
        ...
        $scope.find('.wixi-reveals').each(function () {
            ...
            if ( myElement.length ) {
                ...
                if ( 'content' === mytype ) {
                    var myId                = myElement.find('.wixi-reveal-item').attr('id');
                ...
                if ( 'modal' === mytype ) {
                    ...
                    myElement.find('.wixi--modal-open').on('click', function() {
    ...
    jQuery(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/wixi-block-revealers.default', elemReveals );
    });
})();