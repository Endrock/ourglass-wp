...
class Wixi_Svg_Pattern extends Widget_Base {

    use Wixi_Helper;

    public function get_name() {
        return 'wixi-svg-pattern';
    }
    ...
    public function __construct($data = [], $args = null) {
        ...
        wp_register_style( 'wixi-svg-pattern-css', WIXI_PLUGIN_URL. 'widgets/svg-pattern/style.css');
    }
    public function get_style_depends() {
        return [ 'wixi-svg-pattern-css' ];
    }

    // Registering Controls
    protected function register_controls() {
        /*****   START CONTROLS SECTION   ******/
        $this->start_controls_section('wixi_svg_pattern_settings',
            [
        ...
        $this->add_control( 'style',
            [
                ...
                'options' => [
                    ...
                    '8' => esc_html__( 'Style 8', 'wixi' ),
                    '9' => esc_html__( 'Style 9 - Fire', 'wixi' ),
                    '10' => esc_html__( 'Style 10', 'wixi' ),
                    '11' => esc_html__( 'Style 11', 'wixi' ),
                    '12' => esc_html__( 'Style 12', 'wixi' )
                ]
            ]
        );
        ...
        $this->add_control( 'title',
            [
                'label' => esc_html__( 'Input Text', 'wixi' ),
                'type' => Controls_Manager::TEXTAREA,
                'label_block' => true,
                'default' => 'Pattern',
            ]
        );
        $this->wixi_style_typo( 'svg_pattern_typo','{{WRAPPER}} .svg-pattern-wrapper' );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Stripe Color', 'wixi' ),
                'types' => [ 'gradient'],
        ...
        $this->start_controls_section( 'svg_pattern2_style_section',
            [
                'label' => esc_html__( 'Text Color Style', 'wixi' ),
                'tab' => Controls_Manager::TAB_CONTENT,
                 'condition' => ['style' => '2' ]
            ]
        );
        ...
        $this->add_control( 'svg_pattern2_stroke_opacity',
            [
				'label' => esc_html__( 'Stroke Opacity', 'wixi' ),
				'type' => Controls_Manager::NUMBER,
				'min' => 0,
				'max' => 1,
				'step' => 0.1,
        ...
        $this->add_control( 'svg_pattern3_duration',
            [
				'label' => esc_html__( 'Animation Duration', 'wixi' ),
				'type' => Controls_Manager::NUMBER,
				'min' => 0,
				'max' => 20,
				'step' => 1,
        ...
        $this->add_control( 'svg_pattern8_color1',
            [
                'label' => esc_html__( 'Shadow Color', 'wixi' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'separator' => 'before',
        ...
        $this->add_control( 'svg_pattern10_stroke_width2',
            [
				'label' => esc_html__( 'Ring Stroke Width', 'wixi' ),
				'type' => Controls_Manager::NUMBER,
				'min' => 0,
				'max' => 10,
				'step' => 1,
        ...
        $this->add_control( 'svg_pattern10_fill_color2',
            [
                'label' => esc_html__( 'Ring Color', 'wixi' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
        ...
        $this->add_control( 'svg_pattern11_stroke_color2',
            [
                'label' => esc_html__( 'Ring Stroke Color', 'wixi' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
        ...
        $this->add_control( 'svg_pattern11_stroke2_width2',
            [
				'label' => esc_html__( 'Ring Stroke Width 2', 'wixi' ),
				'type' => Controls_Manager::NUMBER,
				'min' => 0,
				'max' => 10,
				'step' => 1,
        ...
        $this->add_control( 'svg_pattern12_fill_color',
            [
                'label' => esc_html__( 'Shadow Fill Color', 'wixi' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
