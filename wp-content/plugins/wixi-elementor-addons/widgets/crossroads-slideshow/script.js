!(function ($) {
    ...
    function crossSlider($Scope, $){
        ...
        $( '.cross-slider .grid__item, .cross-slider .img-wrap' ).hover(
          function() {
            $( '.wixi-cursor' ).addClass( 'hide' );
          }, function() {
            $( '.wixi-cursor' ).removeClass( 'hide' );
          }
        );
    ...
    jQuery(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/wixi-crossroads-slideshow.default', crossSlider);
    });
