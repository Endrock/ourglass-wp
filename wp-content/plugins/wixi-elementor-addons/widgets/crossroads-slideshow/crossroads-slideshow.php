...
class Wixi_Crossroads_Slideshow extends Widget_Base {
    use Wixi_Helper;

    public function get_name() {
        return 'wixi-crossroads-slideshow';
    }
    ...
    public function __construct($data = [], $args = null) {
        ...
        wp_register_style( 'crossroads-slideshow', WIXI_PLUGIN_URL. 'widgets/crossroads-slideshow/style.css');
        wp_register_script( 'charming', WIXI_PLUGIN_URL. 'widgets/crossroads-slideshow/charming.min.js');
        wp_register_script( 'crossroads-slideshow', WIXI_PLUGIN_URL. 'widgets/crossroads-slideshow/script.js');
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control( 'meta',
            [
                'label' => esc_html__( 'Meta/Info', 'wixi' ),
                'type' => Controls_Manager::TEXT,
        ...
        $repeater->add_control( 'link_title',
            [
                'label' => esc_html__( 'Link Title', 'wixi' ),
                'type' => Controls_Manager::TEXT,
                'default' => 'more +',
                'label_block' => true
            ]
        ...
        $this->start_controls_section('front_back_settings',
            [
                'label' => esc_html__( 'Front && Back Additional', 'wixi' ),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_responsive_control( 'image_rotate',
            [
                'label' => esc_html__( 'Image Rotate', 'wixi' ),
        ...
        $this->add_responsive_control( 'revealer_rotate',
            [
                'label' => esc_html__( 'Revealer Rotate', 'wixi' ),
                'type' => Controls_Manager::NUMBER,
                'min' => -90,
                'max' => 90,
                'step' => 1,
        ...
        $this->add_responsive_control( 'title_rotate',
            [
                'label' => esc_html__( 'Titles Rotate', 'wixi' ),
                'type' => Controls_Manager::NUMBER,
                'min' => -90,
                'max' => 90,
                'step' => 1,
        ...
        $this->add_control( 'back_heading',
            [
                'label' => esc_html__( 'BACK', 'wixi' ),
                'type' => Controls_Manager::HEADING,
            ]
        );
        $this->add_responsive_control( 'image_content_height',
            [
                'label' => esc_html__( 'Image Content Height', 'wixi' ),
        ...
        $this->add_responsive_control( 'text_content_width',
            [
                'label' => esc_html__( 'Text Content Max Width', 'wixi' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px','%'],
                'range' => [
                    '%' => [
        ...
        $this->add_control( 'back_layout',
            [
                'label' => esc_html__( 'Back Layout', 'wixi' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'grid-template-col-3',
                'options' => [
                    'grid-template-vertical' => esc_html__( '1 Column', 'wixi' ),
                    'grid-template-col-2' => esc_html__( '2 Column', 'wixi' ),
                    'grid-template-col-3' => esc_html__( '3 Column', 'wixi' ),
                    'grid-template-col-custom' => esc_html__( 'Custom Column', 'wixi' ),
                ]
            ]
        );
        $this->add_responsive_control( 'back_custom_column',
            [
                'label' => esc_html__( 'Change Column Structure', 'wixi' ),
                'type' => Controls_Manager::TEXT,
                'default' => '30% 60% 30%',
                'label_block' => true,
        ...
        $this->wixi_style_background( 'front_bg','{{WRAPPER}} .revealer__inner' );
        ...
        $this->wixi_style_border( 'image_border','{{WRAPPER}} .img-wrap' );
        $this->wixi_style_box_shadow( 'image_bxshadow','{{WRAPPER}} .img-wrap' );
        ...
        $this->wixi_style_typo( 'title_typo','{{WRAPPER}} .grid__item--title' );
        $this->wixi_style_background( 'title_background','{{WRAPPER}} .grid__item--title' );
        $this->wixi_style_padding( 'title_padding','{{WRAPPER}} .grid__item--title' );
        $this->wixi_style_border( 'title_border','{{WRAPPER}} .grid__item--title' );
        $this->wixi_style_box_shadow( 'title_bxshadow','{{WRAPPER}} .grid__item--title' );
        $this->wixi_style_text_shadow( 'title_txthadow','{{WRAPPER}} .grid__item--title span' );
        $this->add_control( 'caption_heading',
            [
                'label' => esc_html__( 'CAPTION', 'wixi' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->wixi_style_typo( 'caption_typo','{{WRAPPER}} .cross-slider .caption' );
        $this->wixi_style_background( 'caption_background','{{WRAPPER}} .cross-slider .caption' );
        $this->wixi_style_padding( 'caption_padding','{{WRAPPER}} .cross-slider .caption' );
        $this->wixi_style_border( 'caption_border','{{WRAPPER}} .cross-slider .caption' );
        $this->wixi_style_box_shadow( 'caption_bxshadow','{{WRAPPER}} .cross-slider .caption' );
        $this->wixi_style_text_shadow( 'caption_txthadow','{{WRAPPER}} .cross-slider .caption' );
        $this->end_controls_section();
        /*****   END CONTROLS SECTION   ******/
        /*****   START CONTROLS SECTION   ******/
        ...
        $this->wixi_style_background( 'back_bg','{{WRAPPER}} .content__item' );
        ...
        $this->wixi_style_border( 'back_image_border','{{WRAPPER}} .img-wrap--content' );
        $this->wixi_style_box_shadow( 'back_image_bxshadow','{{WRAPPER}} .img-wrap--content' );
        ...
        $this->wixi_style_typo( 'back_title_typo','{{WRAPPER}} .content__item-header-title' );
        $this->wixi_style_background( 'back_title_background','{{WRAPPER}} .content__item-header-title' );
        $this->wixi_style_padding( 'back_title_padding','{{WRAPPER}} .content__item-header-title' );
        $this->wixi_style_border( 'back_title_border','{{WRAPPER}} .content__item-header-title' );
        $this->wixi_style_box_shadow( 'back_title_bxshadow','{{WRAPPER}} .content__item-header-title' );
        $this->wixi_style_text_shadow( 'back_title_txthadow','{{WRAPPER}} .content__item-header-title' );
        ...
        $this->wixi_style_typo( 'back_caption_typo','{{WRAPPER}} .content__item-header-meta' );
        $this->wixi_style_background( 'back_caption_background','{{WRAPPER}} .content__item-header-meta' );
        $this->wixi_style_padding( 'back_caption_padding','{{WRAPPER}} .content__item-header-meta' );
        $this->wixi_style_border( 'back_caption_border','{{WRAPPER}} .content__item-header-meta' );
        $this->wixi_style_box_shadow( 'back_caption_bxshadow','{{WRAPPER}} .content__item-header-meta' );
        $this->wixi_style_text_shadow( 'back_caption_txthadow','{{WRAPPER}} .content__item-header-meta' );
        ...
        $this->wixi_style_typo( 'back_text_typo','{{WRAPPER}} .content__item-copy' );
        $this->wixi_style_background( 'back_text_background','{{WRAPPER}} .content__item-copy' );
        $this->wixi_style_padding( 'back_text_padding','{{WRAPPER}} .content__item-copy' );
        $this->wixi_style_border( 'back_text_border','{{WRAPPER}} .content__item-copy' );
        $this->wixi_style_box_shadow( 'back_text_bxshadow','{{WRAPPER}} .content__item-copy' );
        $this->wixi_style_text_shadow( 'back_text_txthadow','{{WRAPPER}} .content__item-copy' );
        $this->end_controls_section();
        /*****   END CONTROLS SECTION   ******/
    }
