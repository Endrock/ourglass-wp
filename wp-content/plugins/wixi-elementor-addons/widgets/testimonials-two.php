...
class Wixi_Testimonials_Two extends Widget_Base {
    use Wixi_Helper;
    public function get_name() {
        return 'wixi-testimonials-two';
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section( 'wixi_testimonials2_settings',
            [
        ...
        $this->add_control( 'type',
            [
                ...
                'options' => [
                    ...
                    '4' => esc_html__( 'Type 4', 'wixi' ),
                    '5' => esc_html__( 'Type 5', 'wixi' ),
                    '6' => esc_html__( 'Type 6', 'wixi' )
                ],
            ]
        );
        ...
        $repeater->add_control( 'info',
            [
                'label' => esc_html__( 'Position / Info', 'wixi' ),
        ...
        $this->add_control( 'name_tag',
            [
                'label' => esc_html__( 'Name Tag', 'wixi' ),
                'type' => Controls_Manager::SELECT,
                'label_block' => 'true',
                'default' => 'h6',
                'options' => [
        ...
        $this->add_control( 'text_tag',
            [
                'label' => esc_html__( 'Quote Text Tag', 'wixi' ),
                'type' => Controls_Manager::SELECT,
                'label_block' => 'true',
                'default' => 'p',
                'options' => [
        ...
        /*****   START CONTROLS SECTION   ******/
        $this->start_controls_section( 'wixi_testimonials2_general_settings',
            [
        ...
        $this->add_control( 'show',
            [
                'label' => esc_html__( 'Show Items', 'wixi' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 1,
                'max' => 6,
                'step' => 1,
        ...
        $this->add_control( 'mdshow',
            [
                'label' => esc_html__( 'Show Items (Tablet)', 'wixi' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 1,
                'max' => 6,
                'step' => 1,
        ...
        $this->add_control( 'smshow',
            [
                'label' => esc_html__( 'Show Items (Phone)', 'wixi' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 1,
                'max' => 6,
                'step' => 1,
        ...
        $this->add_control( 'showscroll',
            [
                'label' => esc_html__( 'Show Scroll Items', 'wixi' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 1,
                'max' => 6,
                'step' => 1,
        ...
        $this->add_control( 'mdarrows',
            [
                'label' => esc_html__( 'Arrows (Tablet)', 'wixi' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'no',
            ]
        );
        $this->add_control( 'smarrows',
            [
                'label' => esc_html__( 'Arrows (Phone)', 'wixi' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'no',
            ]
        );
        ...
        $this->add_control( 'mddots',
            [
                'label' => esc_html__( 'Dots (Tablet)', 'wixi' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'no',
            ]
        );
        $this->add_control( 'smdots',
            [
                'label' => esc_html__( 'Dots (Phone)', 'wixi' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'no',
            ]
        );
        ...
        $this->start_controls_section('testi_item_box_style_section',
            [
                'label'=> esc_html__( 'Item Box Style', 'wixi' ),
        ...
        $this->wixi_style_background( 'box_background','{{WRAPPER}} .testi-item' );
        $this->wixi_style_padding( 'box_padding','{{WRAPPER}} .testi-item' );
        $this->wixi_style_margin( 'box_margin','{{WRAPPER}} .testi-item' );
        $this->wixi_style_border( 'box_border','{{WRAPPER}} .testi-item' );
        $this->wixi_style_box_shadow( 'box_bxshadow','{{WRAPPER}} .testi-item' );
        $this->add_responsive_control( 'box_min_height',
            [
                'label' => esc_html__( 'Minumum Height', 'wixi' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 1000
        ...
        $this->wixi_style_typo( 'quote_typo','{{WRAPPER}} .testi-quote' );
        $this->wixi_style_color( 'quote_color','{{WRAPPER}} .testi-quote' );
        $this->wixi_style_background( 'quote_background','{{WRAPPER}} .testi-quote' );
        $this->wixi_style_padding( 'quote_padding','{{WRAPPER}} .testi-quote' );
        $this->wixi_style_margin( 'quote_margin','{{WRAPPER}} .testi-quote' );
        $this->wixi_style_border( 'quote_border','{{WRAPPER}} .testi-quote' );
        $this->add_control( 'quote_position',
            [
                ...
                'options' => [
                    ...
                    'absolute' => esc_html__( 'Absolute', 'wixi' ),
                ],
                'default' => '',
                'separator' => 'before',
            ]
        ...
        $this->add_responsive_control( 'quote_custom_width',
            [
                'label' => esc_html__( 'Custom Width', 'wixi' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px','%'],
                'range' => [
                    '%' => [
        ...
        $this->add_responsive_control( 'quote_bottom',
            [
                'label' => esc_html__( 'Bottom Offset', 'wixi' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px','%'],
                'range' => [
                    '%' => [
        ...
        $this->add_responsive_control( 'quote_left',
            [
                'label' => esc_html__( 'Left Offset', 'wixi' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px','%'],
                'range' => [
                    '%' => [
        ...
        $this->add_responsive_control( 'quote_right',
            [
                'label' => esc_html__( 'Right Offset', 'wixi' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px','%'],
                'range' => [
                    '%' => [
        ...
        $this->add_control( 'quote_icon_heading',
            [
                'label' => esc_html__( 'QUOTE ICON', 'wixi' ),
        ...
        $this->add_control( 'quote_icon_color',
            [
                'label' => esc_html__( 'Quote Icon Color', 'wixi' ),
        ...
        $this->add_responsive_control( 'quote_icon_top',
            [
                'label' => esc_html__( 'Icon Top Offset', 'wixi' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px','%'],
                'range' => [
                    '%' => [
        ...
        $this->add_responsive_control( 'quote_icon_left',
            [
                'label' => esc_html__( 'Icon Left Offset', 'wixi' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px','%'],
                'range' => [
                    '%' => [
        ...
        $this->start_controls_section('testi_image_style_section',
            [
                'label'=> esc_html__( 'Avatar Image Style', 'wixi' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'conditions' => [
                    'relation' => 'or',
                    'terms' => [
        ...
        $this->wixi_style_padding( 'avatar_padding','{{WRAPPER}} .testi-avatar' );
        $this->wixi_style_margin( 'avatar_margin','{{WRAPPER}} .testi-avatar' );
        $this->wixi_style_border( 'avatar_border','{{WRAPPER}} .testi-avatar' );
        $this->wixi_style_box_shadow( 'avatar_box_shadow','{{WRAPPER}} .testi-avatar' );
        ...
        $this->start_controls_section('testi_footer_style_section',
            [
                'label'=> esc_html__( 'Footer Content Style', 'wixi' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => ['type' => '2']
            ]
        );
        $this->wixi_style_background( 'footer_background','{{WRAPPER}} .testi-2 .testi-footer' );
        $this->wixi_style_padding( 'footer_padding','{{WRAPPER}} .testi-2 .testi-footer' );
        $this->wixi_style_margin( 'footer_margin','{{WRAPPER}} .testi-2 .testi-footer' );
        $this->wixi_style_border( 'footer_border','{{WRAPPER}} .testi-2 .testi-footer' );
        $this->wixi_style_box_shadow( 'footer_box_shadow','{{WRAPPER}} .testi-2 .testi-footer' );
        ...
        $this->start_controls_section('testi_author_style_section',
            [
                'label'=> esc_html__( 'Author Style', 'wixi' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'conditions' => [
                    'relation' => 'or',
                    'terms' => [
        ...
        $this->wixi_style_typo( 'author_typo','{{WRAPPER}} .testi-author' );
        $this->wixi_style_color( 'author_color','{{WRAPPER}} .testi-author' );
        $this->wixi_style_padding( 'author_padding','{{WRAPPER}} .testi-author' );
        $this->wixi_style_margin( 'author_margin','{{WRAPPER}} .testi-author' );
        $this->wixi_style_border( 'author_border','{{WRAPPER}} .testi-author' );
        ...
        $this->start_controls_section('testi_info_style_section',
            [
                'label'=> esc_html__( 'Position / Info Style', 'wixi' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'conditions' => [
                    'relation' => 'or',
                    'terms' => [
        ...
        $this->wixi_style_typo( 'info_typo','{{WRAPPER}} .testi-info' );
        $this->wixi_style_color( 'info_color','{{WRAPPER}} .testi-info' );
        $this->wixi_style_padding( 'info_padding','{{WRAPPER}} .testi-info' );
        $this->wixi_style_margin( 'info_margin','{{WRAPPER}} .testi-info' );
        $this->wixi_style_border( 'info_border','{{WRAPPER}} .testi-info' );
        ...
        $this->start_controls_section('testi_dots_style_section',
            [
                'label'=> esc_html__( 'Dots Style', 'wixi' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => ['dots' => 'yes']
            ]
        );
        ...
        $this->wixi_style_padding( 'dots_padding','{{WRAPPER}} .slick-dots li button' );
        $this->wixi_style_border( 'dots_border','{{WRAPPER}} .slick-dots li button' );
        $this->add_control( 'dots_spacing',
            [
                'label' => esc_html__( 'Spacing', 'wixi' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 100
        ...
        $this->add_control( 'dots_hvrbrdcolor',
            [
                'label' => esc_html__( 'Hover Border Color', 'wixi' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
        ...
        $this->start_controls_section('testi_arrows_style_section',
            [
                'label'=> esc_html__( 'Arrows Style', 'wixi' ),
                'tab' => Controls_Manager::TAB_STYLE,
        ...
        $this->add_responsive_control( 'arrows_navs_position',
            [
                'label' => esc_html__( 'Arrows Content Vertical Position', 'wixi' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px','%'],
                'range' => [
                    '%' => [
        ...
        $this->wixi_style_border( 'arrows_border','{{WRAPPER}} .testimonials2 .slick-arrow' );
        ...
        $this->wixi_style_border( 'arrows_hvrborder','{{WRAPPER}} .testimonials2 .slick-arrow:hover' );
        ...
        $this->start_controls_section( 'fast_style_section',
            [
                'label'=> esc_html__( 'Fast Style', 'wixi' ),
                'tab' => Controls_Manager::TAB_CONTENT,
                'conditions' => [
                    'relation' => 'and',
                    'terms' => [
        ...
        $this->wixi_style_padding( 'item_box_padding','{{WRAPPER}} .testi--new' );
        $this->wixi_style_margin( 'item_box_margin','{{WRAPPER}} .testi--new' );
        $this->wixi_style_border( 'item_box_border','{{WRAPPER}} .testi--new' );
        $this->wixi_style_box_shadow( 'item_box_bxshadow','{{WRAPPER}} .testi--new' );
        ...
        $this->wixi_style_typo( 'item_quot_typo','{{WRAPPER}} .testi--new blockquote.testi-quote' );
        ...
        $this->add_control( 'item_name_heading',
            [
                'label' => esc_html__( 'NAME and INFO', 'wixi' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->wixi_style_typo( 'item_name_typo','{{WRAPPER}} .testi--new .author .testi-author' );
        $this->add_control( 'item_info_color',
            [
                'label' => esc_html__( 'Info Color', 'wixi' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => ['{{WRAPPER}} .testi--new .author .testi-author .testi-info' => 'color: {{VALUE}};']
            ]
        );
        $this->wixi_style_typo( 'item_info_typo','{{WRAPPER}} .testi--new .author .testi-author .testi-info' );
        $this->end_controls_section();
        /*****   END CONTROLS SECTION   ******/
    }
