...
class Wixi_Page_Flip_Layout extends Widget_Base {
    use Wixi_Helper;

    public function get_name() {
        return 'wixi-page-flip-layout';
    }
    ...
    public function __construct($data = [], $args = null) {
        ...
        wp_register_style( 'page-flip-layout', WIXI_PLUGIN_URL. 'widgets/page-flip-layout/style.css');
        wp_register_script( 'page-flip-layout', WIXI_PLUGIN_URL. 'widgets/page-flip-layout/script.js');
    ...
    protected function register_controls() {
        ...
        $repeater->add_control( 'layout',
            [
                'label' => esc_html__( 'Layout', 'wixi' ),
                'type' => Controls_Manager::SELECT,
                'default' => '1',
                'options' => [
                    '1' => esc_html__( 'Layout Type 1', 'wixi' ),
                    '2' => esc_html__( 'Layout Type 2', 'wixi' ),
                    '3' => esc_html__( 'Layout Type 3', 'wixi' ),
                    '4' => esc_html__( 'Layout Type 4', 'wixi' ),
                    '5' => esc_html__( 'Layout Type 5', 'wixi' ),
                ]
            ]
        );
        ...
        $repeater->add_control( 'navtitle',
            [
                'label' => esc_html__( 'Navigation Title', 'wixi' ),
        ...
        $repeater->add_control( 'gallery',
            [
                'label' => esc_html__( 'Gallery Images', 'wixi' ),
        ...
        $repeater->add_control( 'title1',
            [
                'label' => esc_html__( 'First Image Title', 'wixi' ),
                'type' => Controls_Manager::TEXT,
                'default' => 'Kanzu',
                'label_block' => true,
                'separator' => 'before',
        ...
        $repeater->add_control( 'revealer_color1',
            [
                'label' => esc_html__( 'Revealer Left Color', 'wixi' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
        ...
        $repeater->add_control( 'revealer_color2',
            [
                'label' => esc_html__( 'Revealer Right Color', 'wixi' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => ['{{WRAPPER}} {{CURRENT_ITEM}}.revealer__item--left' => 'background-color: {{VALUE}};']
            ]
        ...
        $this->add_control( 'show_menu',
            [
                'label' => esc_html__( 'Show Menu', 'wixi' ),
        ...
        $this->add_control( 'menu_title',
            [
                'label' => esc_html__( 'Menu Title', 'wixi' ),
                'type' => Controls_Manager::TEXT,
                'default' => 'Index',
                'label_block' => true,
        ...
        $this->add_control( 'title_tag',
            [
                'label' => esc_html__( 'Title Tag', 'wixi' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'h4',
                'options' => [
        ...
        $this->start_controls_section('slide_style_settings',
            [
                'label'=> esc_html__( 'Slide Style', 'wixi' ),
        ...
        $this->wixi_style_border( 'back_image_border','{{WRAPPER}} .slide__figure-inner' );
        $this->wixi_style_box_shadow( 'back_image_bxshadow','{{WRAPPER}} .slide__figure-inner' );
        ...
        $this->wixi_style_typo( 'back_title_typo','{{WRAPPER}} .slide__figure-title' );
        $this->wixi_style_background( 'back_title_background','{{WRAPPER}} .slide__figure-title' );
        $this->wixi_style_padding( 'back_title_padding','{{WRAPPER}} .slide__figure-title' );
        $this->wixi_style_border( 'back_title_border','{{WRAPPER}} .slide__figure-title' );
        $this->wixi_style_box_shadow( 'back_title_bxshadow','{{WRAPPER}} .slide__figure-title' );
        $this->wixi_style_text_shadow( 'back_title_txthadow','{{WRAPPER}} .slide__figure-title' );
        ...
        $this->wixi_style_typo( 'desc_typo','{{WRAPPER}} .slide__figure-description' );
        $this->wixi_style_background( 'desc_background','{{WRAPPER}} .slide__figure-description' );
        $this->wixi_style_padding( 'desc_padding','{{WRAPPER}} .slide__figure-description' );
        $this->wixi_style_border( 'desc_border','{{WRAPPER}} .slide__figure-description' );
        $this->wixi_style_box_shadow( 'desc_bxshadow','{{WRAPPER}} .slide__figure-description' );
        $this->wixi_style_text_shadow( 'desc_txthadow','{{WRAPPER}} .slide__figure-description' );
        ...
        $this->wixi_style_typo( 'number_typo','{{WRAPPER}} .slide__number' );
        $this->wixi_style_background( 'number_background','{{WRAPPER}} .slide__number' );
        $this->wixi_style_padding( 'number_padding','{{WRAPPER}} .slide__number' );
        $this->wixi_style_border( 'number_border','{{WRAPPER}} .slide__number' );
        $this->wixi_style_box_shadow( 'number_bxshadow','{{WRAPPER}} .slide__number' );
        $this->wixi_style_text_shadow( 'number_txthadow','{{WRAPPER}} .slide__number' );
        $this->end_controls_section();
        /*****   END CONTROLS SECTION   ******/
        /*****   START CONTROLS SECTION   ******/
        ...
        $this->add_control( 'menu_content_heading',
            [
                'label' => esc_html__( 'MENU CONTAINER', 'wixi' ),
                'type' => Controls_Manager::HEADING,
            ]
        );
        $this->wixi_style_background( 'menu_content_background','{{WRAPPER}} nav.nav.nav--open' );
        $this->wixi_style_padding( 'menu_content_padding','{{WRAPPER}} nav.nav.nav--open' );
        $this->wixi_style_border( 'menu_content_border','{{WRAPPER}} nav.nav.nav--open' );
        $this->add_control( 'menu_heading',
            [
                'label' => esc_html__( 'MENU ITEM', 'wixi' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->wixi_style_typo( 'menu_typo','{{WRAPPER}} .toc a' );
        $this->wixi_style_background( 'menu_background','{{WRAPPER}} .toc a' );
        $this->wixi_style_padding( 'menu_padding','{{WRAPPER}} .toc a' );
        $this->wixi_style_border( 'menu_border','{{WRAPPER}} .toc a' );
        $this->wixi_style_text_shadow( 'menu_txthadow','{{WRAPPER}} .toc a' );
                ...
                foreach ( $settings['slides'] as $item ) {
                    ...
                    echo '<div class="slide elementor-repeater-item-' . $item['_id'] . ' slide--layout-'.$item['layout'].$current.'">';
                        ...
                        foreach ( $item['gallery'] as $image ) {
                            ...
                            $imageurl = wp_get_attachment_image_src( $image['id'], $size );
                            ...
                            if ( '5' == $item['layout'] && $count < 3 ) {
                                ...
                                echo '<figure class="slide__figure">';
                                    ...
                                    echo '<div class="slide__figure-inner">';
                                        echo '<div class="slide__figure-img" style="background-image: url(' . $imageurl[0] . ')"></div>';
