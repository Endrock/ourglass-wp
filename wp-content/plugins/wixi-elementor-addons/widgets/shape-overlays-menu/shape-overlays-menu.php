...
class Wixi_Shape_Overlays_Menu extends Widget_Base {
    use Wixi_Helper;

    public function get_name() {
        return 'wixi-shape-overlays-menu';
    }
    ...
    public function __construct($data = [], $args = null) {
        ...
        wp_register_style( 'shape-overlays-menu', WIXI_PLUGIN_URL. 'widgets/shape-overlays-menu/style.css');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control( 'type',
            [
                ...
                'default' => 'demo-1',
                'options' => [
                    'demo-1' => esc_html__( 'Type-1', 'wixi' ),
                    'demo-2' => esc_html__( 'Type-2', 'wixi' ),
                    'demo-3' => esc_html__( 'Type-3', 'wixi' ),
                    'demo-4' => esc_html__( 'Type-4', 'wixi' ),
                ]
            ]
        );
        ...
        $this->add_responsive_control( 'max_width',
            [
                'label' => esc_html__( 'Max Width', 'wixi' ),
                ...
                'selectors' => ['{{WRAPPER}} nav.wixi-shape-overlay-menu.is-opened-navi .content,{{WRAPPER}} .shape-overlays,{{WRAPPER}} .global-menu' => 'width: {{SIZE}}{{UNIT}};']
            ]
        );
        ...
        $this->start_controls_section('btn_style_settings',
            [
                'label' => esc_html__( 'Button && Shape Style', 'wixi' ),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        $this->add_control( 'btn_anim',
            [
                'label' => esc_html__( 'Glow Animation', 'wixi' ),
                'type' => Controls_Manager::SWITCHER,
            ]
        );
        $this->add_control( 'btn_animcolor',
            [
                'label' => esc_html__( 'Glow Animation Color', 'wixi' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => ['{{WRAPPER}} .wixi-shape-overlay-menu .hamburger::after' => 'border-color: {{VALUE}};']
            ]
        );
        $this->add_responsive_control( 'btn_border_radius',
            [
                ...
                'size_units' => [ '%' ],
                'selectors' => ['{{WRAPPER}} .wixi-shape-overlay-menu .hamburger, {{WRAPPER}} .wixi-shape-overlay-menu .hamburger::after' => 'border-top-left-radius: {{TOP}}{{UNIT}};border-top-right-radius: {{RIGHT}}{{UNIT}};border-bottom-left-radius: {{BOTTOM}}{{UNIT}};border-bottom-right-radius: {{LEFT}}{{UNIT}};'],
                'default' => [
                    'top' => '',
                    'right' => '',
                    'bottom' => '',
        ...
        $this->add_control( 'btn_bgcolor',
            [
                'label' => esc_html__( 'Toggle Background Color', 'wixi' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => ['{{WRAPPER}} .wixi-shape-overlay-menu .hamburger' => 'background-color: {{VALUE}};']
            ]
        );
        $this->add_control( 'bar_color',
            [
                'label' => esc_html__( 'Toggle Bar Color', 'wixi' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
        ...
        $this->add_control( 'btn_hvrbgcolor',
            [
                ...
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => ['{{WRAPPER}} .wixi-shape-overlay-menu .hamburger:hover' => 'background-color: {{VALUE}};']
            ]
        );
        ...
        $this->add_control( 'shape_heading',
            [
                'label' => esc_html__( 'SHAPE COLOR', 'wixi' ),
        ...
        $this->add_control( 'bg_color',
            [
                'label' => esc_html__( 'Overlay Background Color', 'wixi' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control( 'shape1_color',
            [
                'label' => esc_html__( 'Shape 1 Color', 'wixi' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
        ...
        $this->add_control( 'shape2_color',
            [
                'label' => esc_html__( 'Shape 2 Color', 'wixi' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
        ...
        $this->add_control( 'shape3_color',
            [
                'label' => esc_html__( 'Shape 3 Color', 'wixi' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} nav.wixi-shape-overlay-menu a'
            ]
        );
        $this->add_responsive_control( 'menu_padding',
            [
                ...
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px' ],
                'selectors' => ['{{WRAPPER}} nav.wixi-shape-overlay-menu a' => 'padding-top: {{TOP}}{{UNIT}};padding-right: {{RIGHT}}{{UNIT}};padding-bottom: {{BOTTOM}}{{UNIT}};padding-left: {{LEFT}}{{UNIT}};'],
                'default' => [
                    'top' => '',
                    'right' => '',
                    'bottom' => '',
        ...
        $this->add_responsive_control( 'menu_margin',
            [
                ...
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px' ],
                'selectors' => ['{{WRAPPER}} nav.wixi-shape-overlay-menu a' => 'margin-top: {{TOP}}{{UNIT}};margin-right: {{RIGHT}}{{UNIT}};margin-bottom: {{BOTTOM}}{{UNIT}};margin-left: {{LEFT}}{{UNIT}};'],
                'default' => [
                    'top' => '',
                    'right' => '',
                    'bottom' => '',
        ...
        $this->add_control( 'menu_color',
            [
                ...
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => ['{{WRAPPER}} nav.wixi-shape-overlay-menu a' => 'color: {{VALUE}};']
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control( 'menu_border_radius',
            [
                ...
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px' ],
                'selectors' => ['{{WRAPPER}} nav.wixi-shape-overlay-menu a' => 'border-top-left-radius: {{TOP}}{{UNIT}};border-top-right-radius: {{RIGHT}}{{UNIT}};border-bottom-left-radius: {{BOTTOM}}{{UNIT}};border-bottom-right-radius: {{LEFT}}{{UNIT}};'],
                'default' => [
                    'top' => '',
                    'right' => '',
                    'bottom' => '',
        ...
        $this->add_control( 'menu_hvrcolor',
            [
                ...
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => ['{{WRAPPER}} nav.wixi-shape-overlay-menu a:hover' => 'color: {{VALUE}};']
            ]
        );
        $this->add_group_control(
            Group_Control_Border::get_type(),
            [
                'name' => 'menu_hvrborder',
                'label' => esc_html__( 'Border', 'wixi' ),
                'selector' => '{{WRAPPER}} nav.wixi-shape-overlay-menu a:hover',
                'separator' => 'before'
            ]
        );
        $this->add_responsive_control( 'menu_hvrborder_radius',
            [
                ...
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px' ],
                'selectors' => ['{{WRAPPER}} nav.wixi-shape-overlay-menu a:hover' => 'border-top-left-radius: {{TOP}}{{UNIT}};border-top-right-radius: {{RIGHT}}{{UNIT}};border-bottom-left-radius: {{BOTTOM}}{{UNIT}};border-bottom-right-radius: {{LEFT}}{{UNIT}};'],
                'default' => [
                    'top' => '',
                    'right' => '',
                    'bottom' => '',
    ...
    protected function render()
    {
        ...
        echo '<nav class="main wixi-shape-overlay-menu '.$settings['type'].'">
