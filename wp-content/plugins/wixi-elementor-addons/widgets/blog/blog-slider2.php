...
class Wixi_Blog_Slider2 extends Widget_Base {
    use Wixi_Helper;
    public function get_name() {
        return 'wixi-blog-slider2';
    }
    ...
    public function __construct($data = [], $args = null) {
        ...
        wp_register_script( 'blog-slider', WIXI_PLUGIN_URL. 'widgets/blog/scripts.js');
    }
    public function get_style_depends() {
        return [ 'swiper','wixi-blog-grid' ];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control( 'general_thumb_heading',
            [
                'label' => esc_html__( 'THUMBNAIL', 'wixi' ),
        ...
        $this->add_control( 'general_post_count_heading',
            [
                'label' => esc_html__( 'POST COUNT', 'wixi' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control( 'general_slider_settings_heading',
            [
                'label' => esc_html__( 'SLIDER SETTINGS', 'wixi' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control( 'hoverstop',
            [
                'label' => esc_html__( 'Stop Hover', 'wixi' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes',
            ]
        );
        $this->add_control( 'coverflow',
            [
                'label' => esc_html__( 'Coverflow Effect', 'wixi' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'no',
            ]
        );
        ...
        $this->add_control( 'centered',
            [
                'label' => esc_html__( 'Centered', 'wixi' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes',
                'condition' => ['coverflow' => 'yes'],
            ]
        ...
        $this->add_control( 'overflow_type',
            [
                ...
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'hidden' => esc_html__( 'Hidden', 'wixi' ),
                    'visible' => esc_html__( 'Visible', 'wixi' ),
                ],
                'default' => 'visible',
                'condition' => ['coverflow' => 'yes'],
        ...
        $this->add_control( 'general_slider_container_heading',
            [
                'label' => esc_html__( 'SLIDER CONTAINER', 'wixi' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->wixi_style_padding( 'slider_container_padding','{{WRAPPER}} .blog--slider-wrapper .swiper-container' );
        $this->add_responsive_control( 'slider_container_minheight',
            [
                'label' => esc_html__( 'Min Height', 'wixi' ),
        ...
        $this->add_responsive_control( 'scrollbar_rail_width',
            [
                'label' => esc_html__( 'Scrollbar Max Width', 'wixi' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px','%'],
                'range' => [
                    '%' => [
        ...
        $this->add_control( 'scrollbar_height',
            [
                'label' => esc_html__( 'Scrollbar Height', 'wixi' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 0,
                'max' => 100,
                'step' => 1,
        ...
        $this->add_control( 'scrollbar_rail_color',
            [
                'label' => esc_html__( 'Scrollbar Rail Color', 'wixi' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
        ...
        $this->add_control( 'scrollbar_color',
            [
                'label' => esc_html__( 'Scrollbar Color', 'wixi' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => ['{{WRAPPER}} .swiper-scrollbar-drag' => 'background-color:{{VALUE}};' ],
            ]
        );
        $this->wixi_style_border( 'scrollbar_border','{{WRAPPER}} .swiper-scrollbar' );
        ...
        $this->wixi_style_margin( 'nav_margin','{{WRAPPER}} .blog--slider-wrapper .swiper-nav-wrapper' );
        $this->wixi_style_padding( 'nav_padding','{{WRAPPER}} .blog--slider-wrapper .swiper-nav-wrapper' );
        ...
        $this->wixi_style_border( 'arrows_border','{{WRAPPER}} .swiper-nav-ctrl' );
        ...
        $this->wixi_style_border( 'arrows_hvrborder','{{WRAPPER}} .swiper-nav-ctrl:hover' );
