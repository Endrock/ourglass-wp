...
class Wixi_Blog_Masonry extends Widget_Base {
    use Wixi_Helper;
    public function get_name() {
        return 'wixi-blog-masonry';
    }
    ...
    protected function render()
    {
        ...
        if ( $the_query->have_posts() ) {
            ...
            echo '<div class="blog--layout-grid-wrapper"><div id="blog--masonry-'.$id.'" class="row '.$is_admin.'">'.$html.'</div>'.$pag.'</div>';
