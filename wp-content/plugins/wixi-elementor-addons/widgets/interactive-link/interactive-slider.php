...
class Wixi_Interactive_Link_Slider extends Widget_Base {
    use Wixi_Helper;

    public function get_name() {
        return 'wixi-interactive-link-slider';
    }
    ...
    public function __construct($data = [], $args = null) {
        ...
        wp_register_style( 'interactive-link-slider', WIXI_PLUGIN_URL. 'widgets/interactive-link/style.css');
        wp_register_script( 'interactive-link-slider', WIXI_PLUGIN_URL. 'widgets/interactive-link/script.js');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control( 'border_color',
            [
                'label' => esc_html__( 'Vertical Line Color', 'wixi' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
        ...
        $this->wixi_style_typo( 'number_typo','{{WRAPPER}} .slide-item-number' );
        $this->wixi_style_background( 'number_background','{{WRAPPER}} .slide-item-number' );
        $this->wixi_style_padding( 'number_padding','{{WRAPPER}} .slide-item-number' );
        $this->wixi_style_margin( 'number_margin','{{WRAPPER}} .slide-item-number' );
        $this->wixi_style_border( 'number_border','{{WRAPPER}} .slide-item-number' );
        $this->wixi_style_text_shadow( 'number_txtshadow','{{WRAPPER}} .slide-item-number' );
        ...
        $this->add_responsive_control( 'number_line_left',
            [
                'label' => esc_html__( 'Line Left Offset', 'wixi' ),
                'type' => Controls_Manager::NUMBER,
                'min' => -300,
                'max' => 300,
                'step' => 1,
        ...
        $this->wixi_style_typo( 'title_typo','{{WRAPPER}} .slide-item-title' );
        $this->wixi_style_background( 'title_background','{{WRAPPER}} .slide-item-title' );
        $this->wixi_style_padding( 'title_padding','{{WRAPPER}} .slide-item-title' );
        $this->wixi_style_margin( 'title_margin','{{WRAPPER}} .slide-item-title' );
        $this->wixi_style_border( 'title_border','{{WRAPPER}} .slide-item-title' );
        $this->wixi_style_text_shadow( 'title_txtshadow','{{WRAPPER}} .slide-item-title' );
        ...
        $this->wixi_style_typo( 'desc_typo','{{WRAPPER}} .slide-item-text' );
        $this->wixi_style_background( 'desc_background','{{WRAPPER}} .slide-item-text' );
        $this->wixi_style_padding( 'desc_padding','{{WRAPPER}} .slide-item-text' );
        $this->wixi_style_margin( 'desc_margin','{{WRAPPER}} .slide-item-text' );
        $this->wixi_style_border( 'desc_border','{{WRAPPER}} .slide-item-text' );
        $this->wixi_style_text_shadow( 'desc_txtshadow','{{WRAPPER}} .slide-item-text' );
        ...
        $this->wixi_style_typo( 'btn_typo','{{WRAPPER}} .slide-item-footer .slide-item-btn' );
        $this->wixi_style_padding( 'btn_padding','{{WRAPPER}} .slide-item-footer .slide-item-btn' );
        $this->wixi_style_margin( 'btn_margin','{{WRAPPER}} .slide-item-footer .slide-item-btn' );
        ...
        $this->wixi_style_border( 'btn_border','{{WRAPPER}} .slide-item-footer .slide-item-btn' );
        ...
        $this->wixi_style_border( 'btn_hvrborder','{{WRAPPER}} .slide-item-footer .slide-item-btn:hover' );
        $this->end_controls_tab();
