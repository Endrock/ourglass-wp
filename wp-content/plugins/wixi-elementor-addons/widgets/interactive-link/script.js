!(function ($) {
    ...
    function interactiveLinkSlider($Scope, $){
        ...
        var myThumbs = new Swiper(galleryThumbs, {
            ...
            simulateTouch: false,
            grabCursor: true,
            slideActiveClass: 'swiper-slide-active swiper-slide-thumb-active',
            on: {
                init: function() {
        ...
        if ( $(window).width() <= 768 ) {
            myThumbs.on('slideChange', function() {
                var activeIndex = myThumbs.activeIndex;
    ...
    jQuery(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/wixi-interactive-link-slider.default', interactiveLinkSlider);
    });
