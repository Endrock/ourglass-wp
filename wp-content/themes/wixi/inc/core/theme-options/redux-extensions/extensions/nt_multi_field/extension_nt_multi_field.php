        ...
        private function is_minimum_version () {
            ...
            if ($this->min_redux_version != '') {
                if (version_compare($redux_ver, $this->min_redux_version) < 0) {
                    $msg = '<strong>' . esc_html__( 'The', 'wixi') . ' ' .  $this->ext_name . ' ' .  esc_html__('extension requires', 'wixi') . ' Redux Framework ' . esc_html__('version', 'wixi') . ' ' . $this->min_redux_version . ' ' .  esc_html__('or higher.','wixi' ) . '</strong>&nbsp;&nbsp;' . esc_html__( 'You are currently running', 'wixi') . ' Redux Framework ' . esc_html__('version','wixi' ) . ' ' . $redux_ver . '.<br/><br/>' . esc_html__('This field will not render in your option panel, and features of this extension will not be available until the latest version of','wixi' ) . ' Redux Framework ' . esc_html__('has been installed.','wixi' );
